...
docker build -t ibaiul/family-recipes:food-service-read-model-local --build-arg MODULE_NAME=read-model --build-arg NEWRELIC_AGENT_VERSION=8.9.1 -f Dockerfile .
